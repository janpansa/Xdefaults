...
<?php if (!empty($page['map_contact'])): ?>
<section id="section-map">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" ><?php print render($page['map_contact']); ?></div>
        </div>
    </div>
</section>
<?php endif; ?>
<div class="morespace-contact"></div>
<?php if (!empty($page['sidebar_contact']) || !empty($page['main_contact'])): ?>
<section id="section-contact">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" ><?php print render($page['sidebar_contact']); ?></div>
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9" ><?php print render($page['main_contact']); ?></div>
        </div>
    </div>
</section>
<?php endif; ?>
